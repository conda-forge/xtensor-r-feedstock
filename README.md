...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/xtensor-r-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/xtensor-r-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/xtensor-r-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/xtensor-r-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/xtensor-r-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/xtensor-r-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `xtensor-r` can be installed with:

```
conda install xtensor-r
```

It is possible to list all of the versions of `xtensor-r` available on your platform with:
